...
public class modelController {
	...
	public String ChatShow (@ModelAttribute ChatForm form, Model model ,Logintb logintb) {
		...
		if(("1").equals(form.getSubmitFlg())) {
			inquiry.inquiryInsert(form, today());
			model.addAttribute("submitFlg",form.getSubmitFlg());
		}

		model.addAttribute("Inquirer",userName);
		model.addAttribute("InquirerId",userId);
